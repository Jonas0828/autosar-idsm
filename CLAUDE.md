...
- **Testing / deployment guides**: `docs/attack-testing-guide.md` (how to test all 12 eth_probe detectors + common pitfalls like nmap -Pn, slow-scan window) and `docs/soc-deployment-guide.md` (local SOC stack bring-up + troubleshooting).
